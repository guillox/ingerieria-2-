<div>
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    ?>
        ...
        <li role="presentation" class=""><a href="#Subastas" aria-controls="Subastas" role="tab" data-toggle="tab">Subastas</a></li>
...
?>
  ...
  <div class="tab-content">
      <div role="tabpanel" class="tab-pane " id="home"><?php require_once 'view/historialSubastaUsuario.php'; ?></div>
        ...
        <div role="tabpanel" class="tab-pane active" id="Usuarios"><?php require_once 'view/reporteUsuarios.php'; ?></div>
      <div role="tabpanel" class="tab-pane" id="Subastas"><?php require_once 'view/reporteSubastas.php'; ?></div>
